...
- Accepts URI to sign messages.
    - URIs of the format INTICOIN:http://domain/something/?a=INTICOIN_address&m=some_message will make the wallet to sign “some_message” and return the produced signature as a POST request to the URL specified in the URI.
...
- INTICOIN-tx tool has been updated to use INTICOIN’s own transaction structure
