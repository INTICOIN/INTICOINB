...
You can read more about [NPIP0003 on the NPIP GitHub](https://github.com/INTICOIN/npips/blob/master/npip-0003.mediawiki).
...
You can read more about [NPIP0005 on the NPIP GitHub](https://github.com/INTICOIN/npips/blob/master/npip-0005.mediawiki).
...
```
createproposal INTICOINaddress amount duration "desc" fee

Arguments:
1. "INTICOINaddress" (string, required) The INTICOIN address where coins would be sent if the proposal is approved.
