...
This document provides guidelines for internationalization of the INTICOIN Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `INTICOIN_en.ts` remains unchanged.
