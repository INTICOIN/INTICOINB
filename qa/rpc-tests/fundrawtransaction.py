...
class RawTransactionsTest(INTICOINTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid INTICOIN address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid INTICOIN address" in e.error['message'])
