...
unlocked to sign the INTICOIN-Qt.app bundle.
...
allowing somebody to distribute a INTICOIN-Qt.app or INTICOIN-qt-setup.exe with a valid
...
that the INTICOIN-qt.exe file inside the installer had not been tampered with.
