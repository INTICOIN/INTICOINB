...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s INTICOIN-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  INTICOIN-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded INTICOIN transaction") + "\n" +
              "  INTICOIN-tx [options] -create [commands]   " + _("Create hex-encoded INTICOIN transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded INTICOIN transaction
