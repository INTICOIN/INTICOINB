/* src/config/INTICOIN-config.h.  Generated from INTICOIN-config.h.in by configure.  */
/* src/config/INTICOIN-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef INTICOIN_CONFIG_H

#define INTICOIN_CONFIG_H
...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The INTICOIN Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "INTICOIN Core"
...
#define PACKAGE_BUGREPORT "https://github.com/INTICOIN/INTICOIN"

/* Define to the full name of this package. */
#define PACKAGE_NAME "INTICOIN Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "INTICOIN Core 4.4.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "INTICOIN"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://www.INTICOIN.qollqrex.org/"
