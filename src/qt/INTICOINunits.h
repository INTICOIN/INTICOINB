...
#ifndef INTICOIN_QT_INTICOINUNITS_H
#define INTICOIN_QT_INTICOINUNITS_H
...
/** INTICOIN unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class INTICOINUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit INTICOINUnits(QObject *parent);

    /** INTICOIN units.
      @note Source: https://en.INTICOIN.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        NAV,
...
typedef INTICOINUnits::Unit INTICOINUnit;

#endif // INTICOIN_QT_INTICOINUNITS_H
