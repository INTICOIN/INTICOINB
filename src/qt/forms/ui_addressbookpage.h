...
public:
    ...
    void setupUi(QWidget *AddressBookPage)
    {
        ...
        newAddress->setStyleSheet(QStringLiteral(""));
        QIcon icon;
        ...
        copyAddress->setStyleSheet(QStringLiteral(""));
        QIcon icon1;
        ...
        deleteAddress->setStyleSheet(QStringLiteral(""));
        QIcon icon2;
        ...
        showPrivateKey = new QPushButton(AddressBookPage);
        showPrivateKey->setObjectName(QStringLiteral("showPrivateKey"));

        horizontalLayout->addWidget(showPrivateKey);
        ...
        exportButton->setStyleSheet(QStringLiteral(""));
        QIcon icon3;
    ...
    void retranslateUi(QWidget *AddressBookPage)
    {
        ...
        showPrivateKey->setText(QApplication::translate("AddressBookPage", "Show Private Key", 0));
#ifndef QT_NO_TOOLTIP
