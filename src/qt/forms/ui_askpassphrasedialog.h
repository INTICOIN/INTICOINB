...
public:
    ...
    void setupUi(QDialog *AskPassphraseDialog)
    {
        ...
        passEdit1->setStyleSheet(QStringLiteral("background: #fff"));
        ...
        passEdit2->setStyleSheet(QStringLiteral("background: #fff"));
        ...
        passEdit3->setStyleSheet(QStringLiteral("background: #fff"));
    ...
    void retranslateUi(QDialog *AskPassphraseDialog)
    {
        ...
        stakingCheckBox->setText(QApplication::translate("AskPassphraseDialog", "Unlock only for staking", 0));
    } // retranslateUi
