...
public:
    ...
    void setupUi(QWidget *RPCConsole)
    {
        ...
        RPCConsole->resize(740, 595);
        RPCConsole->setStyleSheet(QStringLiteral(": #eff1f4; border: 0"));
        ...
        fontSmallerButton->setStyleSheet(QStringLiteral(""));
        QIcon icon;
        ...
        fontBiggerButton->setStyleSheet(QStringLiteral(""));
        QIcon icon1;
        ...
        promptIcon->setStyleSheet(QStringLiteral(""));
        QIcon icon3;
        ...
        btnClearTrafficGraph->setStyleSheet(QStringLiteral(" background: #f6f6f6; border: 2px solid #a9adc4; border-radius: 5px; padding: 6px; text-transform: uppercase; color: #616998; font-weight: bold"));
        ...
        QPalette palette;
        QBrush brush(QColor(239, 241, 244, 255));
