...
public:
    ...
    void setupUi(QDialog *HelpMessageDialog)
    {
        ...
        aboutLogo->setPixmap(QPixmap(QString::fromUtf8(":/icons/INTICOIN")));
        ...
        helpMessage->setStyleSheet(QStringLiteral(""));
        ...
        scrollAreaWidgetContents->setGeometry(QRect(0, 0, 718, 111));
