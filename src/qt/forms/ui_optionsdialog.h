...
public:
    ...
    QLabel *voteQuestionLabel;
    QHBoxLayout *horizontalLayout_2;
    QLabel *voteLabel;
    QLineEdit *voteTextField;
    ...
    QPushButton *openINTICOINConfButton;
    ...
    void setupUi(QDialog *OptionsDialog)
    {
        ...
        INTICOINAtStartup = new QCheckBox(tabMain);
        INTICOINAtStartup->setObjectName(QStringLiteral("INTICOINAtStartup"));

        verticalLayout_Main->addWidget(INTICOINAtStartup);
        ...
        databaseCache->setStyleSheet(QStringLiteral(""));
        databaseCache->setFrame(true);
        databaseCache->setButtonSymbols(QAbstractSpinBox::NoButtons);
        ...
        threadsScriptVerif->setStyleSheet(QStringLiteral(""));
        threadsScriptVerif->setFrame(true);
        threadsScriptVerif->setButtonSymbols(QAbstractSpinBox::NoButtons);
        ...
        voteQuestionLabel = new QLabel(tabMain);
        voteQuestionLabel->setObjectName(QStringLiteral("voteQuestionLabel"));

        horizontalLayout_3->addWidget(voteQuestionLabel);
        ...
        voteLabel = new QLabel(tabMain);
        voteLabel->setObjectName(QStringLiteral("voteLabel"));
        QSizePolicy sizePolicy(QSizePolicy::Minimum, QSizePolicy::Preferred);
        sizePolicy.setHorizontalStretch(0);
        sizePolicy.setVerticalStretch(0);
        sizePolicy.setHeightForWidth(voteLabel->sizePolicy().hasHeightForWidth());
        voteLabel->setSizePolicy(sizePolicy);

        horizontalLayout_2->addWidget(voteLabel);

        voteTextField = new QLineEdit(tabMain);
        voteTextField->setObjectName(QStringLiteral("voteTextField"));
        voteTextField->setMaximumSize(QSize(150, 16777215));

        horizontalLayout_2->addWidget(voteTextField);
        ...
        lang->setStyleSheet(QStringLiteral(""));
        ...
        unit->setStyleSheet(QStringLiteral(""));
        ...
        thirdPartyTxUrls->setStyleSheet(QStringLiteral(""));
        ...
        openINTICOINConfButton = new QPushButton(OptionsDialog);
        openINTICOINConfButton->setObjectName(QStringLiteral("openINTICOINConfButton"));
        openINTICOINConfButton->setAutoDefault(false);

        verticalLayout_Buttons->addWidget(openINTICOINConfButton);
    ...
    void retranslateUi(QDialog *OptionsDialog)
    {
        ...
        INTICOINAtStartup->setToolTip(QApplication::translate("OptionsDialog", "Automatically start %1 after logging in to the system.", 0));
#endif // QT_NO_TOOLTIP
        INTICOINAtStartup->setText(QApplication::translate("OptionsDialog", "&Start %1 on system login", 0));
...
#endif // QT_NO_TOOLTIP
        voteQuestionLabel->setText(QString());
        voteLabel->setText(QApplication::translate("OptionsDialog", "Your Staker vote", 0));
...
#ifndef QT_NO_TOOLTIP
        mapPortUpnp->setToolTip(QApplication::translate("OptionsDialog", "Automatically open the INTICOIN client port on the router. This only works when your router supports UPnP and it is enabled.", 0));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        connectSocks->setToolTip(QApplication::translate("OptionsDialog", "Connect to the INTICOIN network through a SOCKS5 proxy.", 0));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        connectSocksTor->setToolTip(QApplication::translate("OptionsDialog", "Connect to the INTICOIN network through a separate SOCKS5 proxy for Tor hidden services.", 0));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        openINTICOINConfButton->setToolTip(QApplication::translate("OptionsDialog", "Open the %1 configuration file from the working directory.", 0));
#endif // QT_NO_TOOLTIP
        openINTICOINConfButton->setText(QApplication::translate("OptionsDialog", "Open Configuration File", 0));
#ifndef QT_NO_TOOLTIP
