...
public:
    ...
    void setupUi(QDialog *ReceiveRequestDialog)
    {
        ...
        outUri->setStyleSheet(QStringLiteral(""));
        ...
        btnCopyURI->setStyleSheet(QStringLiteral(""));
        ...
        btnCopyAddress->setStyleSheet(QStringLiteral(""));
        ...
        btnSaveAs->setStyleSheet(QStringLiteral(""));
