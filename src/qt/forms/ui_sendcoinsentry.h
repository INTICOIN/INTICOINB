...
public:
    ...
    INTICOINAmountField *payAmount_is;
    ...
    INTICOINAmountField *payAmount_s;
    ...
    void setupUi(QStackedWidget *SendCoinsEntry)
    {
        ...
        sizePolicy.setHeightForWidth(addAsLabel->sizePolicy().hasHeightForWidth());
        addAsLabel->setSizePolicy(sizePolicy);
        addAsLabel->setStyleSheet(QStringLiteral(""));

        gridLayout->addWidget(addAsLabel, 3, 2, 1, 1);
        ...
        messageTextLabel->setStyleSheet(QStringLiteral(""));
        messageTextLabel->setTextFormat(Qt::PlainText);

        gridLayout->addWidget(messageTextLabel, 12, 2, 1, 1);
        ...
        gridLayout->addWidget(payToLabel, 1, 1, 1, 1);
        ...
        addressBookButton->setToolTip(QStringLiteral(""));
#endif // QT_NO_TOOLTIP
        addressBookButton->setStyleSheet(QStringLiteral("border:0;background:transparent"));
        QIcon icon;
        ...
        gridLayout->addLayout(payToLayout, 1, 2, 1, 1);

        verticalSpacer_3 = new QSpacerItem(20, 40, QSizePolicy::Minimum, QSizePolicy::Expanding);

        gridLayout->addItem(verticalSpacer_3, 10, 2, 1, 1);

        addressBookCheckBox = new QCheckBox(SendCoins);
        addressBookCheckBox->setObjectName(QStringLiteral("addressBookCheckBox"));
        QFont font1;
        font1.setPointSize(10);
        addressBookCheckBox->setFont(font1);

        gridLayout->addWidget(addressBookCheckBox, 2, 2, 1, 1);
        ...
        gridLayout->addWidget(amountLabel, 6, 1, 1, 1);

        verticalSpacer_2 = new QSpacerItem(20, 40, QSizePolicy::Minimum, QSizePolicy::Expanding);

        gridLayout->addItem(verticalSpacer_2, 13, 2, 1, 1);
        ...
        checkboxSubtractFeeFromAmount->setFont(font1);

        gridLayout->addWidget(checkboxSubtractFeeFromAmount, 7, 2, 1, 1);
        ...
        QBrush brush1(QColor(239, 241, 244, 255));
        ...
        payTo_is->setStyleSheet(QStringLiteral("background: #fff; border-radius: 4px; border: 1px solid #000; padding:2px"));
        ...
        memoTextLabel_is->setStyleSheet(QStringLiteral("background: #fff; border-radius: 4px; border: 1px solid #000; padding:2px"));
        ...
        payAmount_is = new INTICOINAmountField(SendCoins_UnauthenticatedPaymentRequest);
        payAmount_is->setObjectName(QStringLiteral("payAmount_is"));
        payAmount_is->setAcceptDrops(false);
        payAmount_is->setStyleSheet(QStringLiteral("background: #fff; border-radius: 4px; border: 1px solid #000; padding:2px"));
        ...
        SendCoins_AuthenticatedPaymentRequest->setStyleSheet(QStringLiteral("background: #eff1f4; border: 0"));
        ...
        payTo_s->setStyleSheet(QStringLiteral("background: #fff; border-radius: 4px; border: 1px solid #000; padding:2px"));
        ...
        memoTextLabel_s->setStyleSheet(QStringLiteral("background: #fff; border-radius: 4px; border: 1px solid #000; padding:2px"));
        ...
        payAmount_s = new INTICOINAmountField(SendCoins_AuthenticatedPaymentRequest);
        payAmount_s->setObjectName(QStringLiteral("payAmount_s"));
        payAmount_s->setAcceptDrops(false);
        payAmount_s->setStyleSheet(QStringLiteral("background: #fff; border-radius: 4px; border: 1px solid #000; padding:2px"));
        ...
        QWidget::setTabOrder(addressBookButton, payAmount);
...
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
        messageTextLabel->setToolTip(QApplication::translate("SendCoinsEntry", "A message that was attached to the INTICOIN: URI which will be stored with the transaction for your reference. Note: This message will not be sent over the INTICOIN network.", 0));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        payTo->setToolTip(QApplication::translate("SendCoinsEntry", "The INTICOIN address to send the payment to", 0));
#endif // QT_NO_TOOLTIP
        addressBookButton->setText(QString());
        addressBookButton->setShortcut(QApplication::translate("SendCoinsEntry", "Alt+A", 0));
        addressBookCheckBox->setText(QApplication::translate("SendCoinsEntry", "Save in Address Book", 0));
        amountLabel->setText(QApplication::translate("SendCoinsEntry", "A&mount (NAV):", 0));
#ifndef QT_NO_TOOLTIP
        checkboxSubtractFeeFromAmount->setToolTip(QApplication::translate("SendCoinsEntry", "The fee will be deducted from the amount being sent. The recipient will receive less INTICOINs than you enter in the amount field. If multiple recipients are selected, the fee is split equally.", 0));
#endif // QT_NO_TOOLTIP
