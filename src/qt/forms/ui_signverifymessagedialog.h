...
public:
    ...
    void setupUi(QDialog *SignVerifyMessageDialog)
    {
        ...
        addressBookButton_SM->setStyleSheet(QStringLiteral(""));
        QIcon icon;
        ...
        pasteButton_SM->setStyleSheet(QStringLiteral(""));
        QIcon icon1;
        ...
        copySignatureButton_SM->setStyleSheet(QStringLiteral(""));
        QIcon icon2;
        ...
        addressIn_VM->setStyleSheet(QStringLiteral(""));
        ...
        addressBookButton_VM->setStyleSheet(QStringLiteral(""));
        ...
        messageIn_VM->setStyleSheet(QStringLiteral(""));
        ...
        signatureIn_VM->setStyleSheet(QStringLiteral(""));
    ...
    void retranslateUi(QDialog *SignVerifyMessageDialog)
    {
        ...
        addressIn_SM->setToolTip(QApplication::translate("SignVerifyMessageDialog", "The INTICOIN address to sign the message with", 0));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        signMessageButton_SM->setToolTip(QApplication::translate("SignVerifyMessageDialog", "Sign the message to prove you own this INTICOIN address", 0));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        addressIn_VM->setToolTip(QApplication::translate("SignVerifyMessageDialog", "The INTICOIN address the message was signed with", 0));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        verifyMessageButton_VM->setToolTip(QApplication::translate("SignVerifyMessageDialog", "Verify the message to ensure it was signed with the specified INTICOIN address", 0));
#endif // QT_NO_TOOLTIP
