    ...
    mapper(0)
{
    ...
    ui->INTICOINAtStartup->setToolTip(ui->INTICOINAtStartup->toolTip().arg(tr(PACKAGE_NAME)));
    ui->INTICOINAtStartup->setText(ui->INTICOINAtStartup->text().arg(tr(PACKAGE_NAME)));
    ...
    ui->unit->setModel(new INTICOINUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->INTICOINAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openINTICOINConfButton_clicked()
{
