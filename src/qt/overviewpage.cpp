...
public:
    TxViewDelegate(const PlatformStyle *platformStyle):
        QAbstractItemDelegate(), unit(INTICOINUnits::NAV),
                      ...
                      const QModelIndex &index ) const
    {
        ...
        QString amountText = INTICOINUnits::formatWithUnit(unit, amount, true, INTICOINUnits::separatorAlways);
        if(!confirmed)
        {
...
void OverviewPage::setBalance(const CAmount& balance, const CAmount& unconfirmedBalance, const CAmount& stakingBalance, const CAmount& immatureBalance, const CAmount& watchOnlyBalance, const CAmount& watchUnconfBalance, const CAmount& watchImmatureBalance)
{
    ...
    ui->labelBalance->setText(INTICOINUnits::formatWithUnit(unit, balance, false, INTICOINUnits::separatorAlways));
    ui->labelUnconfirmed->setText(INTICOINUnits::formatWithUnit(unit, unconfirmedBalance, false, INTICOINUnits::separatorAlways));
    ui->labelStaking->setText(INTICOINUnits::formatWithUnit(unit, stakingBalance, false, INTICOINUnits::separatorAlways));
    ui->labelImmature->setText(INTICOINUnits::formatWithUnit(unit, immatureBalance, false, INTICOINUnits::separatorAlways));
    ui->labelTotal->setText(INTICOINUnits::formatWithUnit(unit, balance + unconfirmedBalance + stakingBalance, false, INTICOINUnits::separatorAlways));
...
void OverviewPage::updateStakeReport(bool fImmediate=false)
{
    ...
    ui->label24hStakingStats->setText(INTICOINUnits::formatWithUnit(unit, aRange[i++].Total, false, INTICOINUnits::separatorAlways));
    ui->label7dStakingStats->setText(INTICOINUnits::formatWithUnit(unit, aRange[i++].Total, false, INTICOINUnits::separatorAlways));
    ui->label30dStakingStats->setText(INTICOINUnits::formatWithUnit(unit, aRange[i++].Total, false, INTICOINUnits::separatorAlways));
    ui->label1yStakingStats->setText(INTICOINUnits::formatWithUnit(unit, aRange[i++].Total, false, INTICOINUnits::separatorAlways));
    ui->labelallStakingStats->setText(INTICOINUnits::formatWithUnit(unit, aRange[i++].Total, false, INTICOINUnits::separatorAlways));
}
