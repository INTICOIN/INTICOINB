    ...
    if(role == Qt::DisplayRole || role == Qt::EditRole)
    {
        ...
        case Amount:
            if (rec->recipient.amount == 0 && role == Qt::DisplayRole)
                ...
                return INTICOINUnits::format(walletModel->getOptionsModel()->getDisplayUnit(), rec->recipient.amount, false, INTICOINUnits::separatorNever);
            else
                return INTICOINUnits::format(walletModel->getOptionsModel()->getDisplayUnit(), rec->recipient.amount);
        }
    }
...
{
    return (this->walletModel->getOptionsModel() != NULL) ? tr("Requested") + " ("+INTICOINUnits::name(this->walletModel->getOptionsModel()->getDisplayUnit()) + ")" : "";
}
