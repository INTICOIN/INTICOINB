...
public:
    ...
    {
        NavTechInit->setWindowTitle(QApplication::translate("NavTechInit", "NavTech Setup", 0));
        label->setText(QApplication::translate("NavTechInit", "INTICOIN uses an unique parallel cluster of nodes called NavTech to protect the privacy of your transactions.", 0));
        label_2->setText(QApplication::translate("NavTechInit", "You will find below the list of the INTICOIN Foundation Servers. Feel free to modify this list to include your prefered servers:", 0));
