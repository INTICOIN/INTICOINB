...
public:
    ...
    {
        navtechitem->setWindowTitle(QApplication::translate("navtechitem", "Form", 0));
        serverNameLabel->setText(QApplication::translate("navtechitem", "Server Name", 0));
        serverHostLabel->setText(QApplication::translate("navtechitem", "127.0.0.1:3000", 0));
        getInfoButton->setText(QApplication::translate("navtechitem", "Get Info", 0));
        deleteButton->setText(QApplication::translate("navtechitem", "Delete", 0));
    } // retranslateUi
