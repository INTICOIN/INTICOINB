...
#ifndef INTICOIN_QT_WALLETFRAME_H
#define INTICOIN_QT_WALLETFRAME_H
...
public:
    explicit WalletFrame(const PlatformStyle *platformStyle, INTICOINGUI *_gui = 0);
    ~WalletFrame();
...
#endif // INTICOIN_QT_WALLETFRAME_H
