...
#ifndef INTICOIN_TEST_SCRIPTNUM10_H
#define INTICOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from INTICOIN Core 0.10.0, for cross-comparison.
 */
public:
