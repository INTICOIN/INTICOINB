...
#define BOOST_TEST_MODULE INTICOIN Test Suite

#include "test_INTICOIN.h"
...
TestingSetup::TestingSetup(const std::string& chainName) : BasicTestingSetup(chainName)
{
    const CChainParams& chainparams = Params();
        ...
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_INTICOIN_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
