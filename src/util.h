 ...
 */
#ifndef INTICOIN_UTIL_H
#define INTICOIN_UTIL_H
...
extern const char * const INTICOIN_CONF_FILENAME;
extern const char * const INTICOIN_PID_FILENAME;
...
{
    std::string s = strprintf("INTICOIN-%s", name);
