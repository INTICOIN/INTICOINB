...
BOOST_AUTO_TEST_CASE(rpc_wallet)
{
    ...
    UniValue r;
    CPubKey demoPubkey;
    CINTICOINAddress demoAddress;
    UniValue retValue;
    string strAccount = "walletDemoAccount";
    CINTICOINAddress setaccountDemoAddress;
    {
        LOCK(pwalletMain->cs_wallet);

        demoPubkey = pwalletMain->GenerateNewKey();
        demoAddress = CINTICOINAddress(CTxDestination(demoPubkey.GetID()));
        ...
        setaccountDemoAddress = CINTICOINAddress(CTxDestination(setaccountDemoPubkey.GetID()));
    }
    /*********************************
     * 			setaccount
     *********************************/
    ...
    BOOST_CHECK(CINTICOINAddress(retValue.get_str()).Get() == demoAddress.Get());
    ...
    BOOST_CHECK(CINTICOINAddress(arr[0].get_str()).Get() == demoAddress.Get());
